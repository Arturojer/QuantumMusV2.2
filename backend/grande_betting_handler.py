...
class GrandeBettingHandler:
    ...
    def _resolve_rejection(self, winning_team):
        ...
        if phase['betType'] == 'ordago':
            ...
            logger.info(f"Ordago rejected - awarding pre-ordago amount: {points_awarded}")
            ...
            logger.info(f"Bet rejected after raises - awarding cumulative amount: {points_awarded}")
